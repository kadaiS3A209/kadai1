...
<body>
    <div class="container">
        ...
        <form class="search-form" action="AdminListEmployeesServlet" method="post">
            ...
            <input type="text" id="searchEmpId" name="searchEmpId" value="<c:out value='${searchedEmpId}'/>" placeholder="従業員IDを入力" maxlength=8>
                    ...
                    <tbody>
                        <c:forEach var="emp" items="${employeeList}">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${emp.role == 3}">管理者</c:when>
                                        <c:when test="${emp.role == 1}">受付</c:when>
                                        <c:when test="${emp.role == 2}">医師</c:when>
